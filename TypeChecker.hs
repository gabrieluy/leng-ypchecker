module TypeChecker where
    ...
    checkStms :: CxtVar -> CxtFun -> Type -> [Stm] -> Err CxtVar CxtFun
    checkStms cvar cfun ty [] = return cvar cfun
    checkStms cvar cfun ty (x : xs) = do {
                                    t <- checkStm cvar cfun ty x;
                                    checkStms cvar cfun ty xs
                            }

    checkStm :: CxtVar -> CxtFun -> Type -> Stm -> Err CxtVar CxtFun
    checkStm cvar cfun ty (SAss ident e) = 
